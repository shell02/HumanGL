...
SRCS_DIR = ./src
OBJS_DIR = ./objs
SRCS = main.cpp init.cpp utils.cpp Matrix.cpp Shader.cpp Vector.cpp Camera.cpp Text.cpp Bone.cpp Model.cpp Animation.cpp Animator.cpp Quaternion.cpp Keyframe.cpp BoneTransform.cpp GUI.cpp
